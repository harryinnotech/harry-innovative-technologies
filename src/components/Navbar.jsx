...
export default function Navbar() {
  ...
  return (
    <header onClick={() => { if (open) setOpen(false); }} className="sticky top-0 z-[70] border-b border-slate-200/60 bg-white/80 backdrop-blur-sm md:fixed md:left-0 md:right-0">
